...
void commTxCallback(const lynxmotion::commData msg)
{
	char data = msg.data;
	cp.write(&data, 1);
	ROS_INFO("[%s]: 0x%X.", COMM_MSG_TX, data);
}
...
int main(int argc, char **argv)
{
	...
	ros::Publisher chatter_pub = n.advertise<lynxmotion::commData> (COMM_MSG_RX, 50);
